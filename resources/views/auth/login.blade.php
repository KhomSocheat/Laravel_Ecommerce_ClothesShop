          ...
          <div class="login-form">
            <form method="POST" action="{{ route('login') }}" name="login-form" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray " name="email" @error('email') is-invalid @enderror value="{{ old('email') }}" required="" autocomplete="email"
                  autofocus="">
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{ route('register') }}l" class="btn-text js-show-register">Create Account</a> 
              </div>
            </form>
          </div>
        </div>
